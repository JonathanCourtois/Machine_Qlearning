...
submarineImg = pygame.transform.scale(submarineImg, (int((displayWidth-infoPanelWidth)/10), int(displayHeight/10)))
...
def gameLoop():
    ...
    while running:  
        ...
        player.update(window.gridCoordinate)
